				...
				server.AppendHandlers(
					ghttp.CombineHandlers(
						...
						ghttp.RespondWith(http.StatusAccepted, `{
							 "metadata": {
							    "guid": "519b0d69-19e4-4009-a363-461eb117cf32",
							    "url": "/v2/service_instances/519b0d69-19e4-4009-a363-461eb117cf32",
							  ...
							  "entity": {
							    ...
							    "service_bindings_url": "/v2/service_instances/519b0d69-19e4-4009-a363-461eb117cf32/service_bindings",
							    "service_keys_url": "/v2/service_instances/519b0d69-19e4-4009-a363-461eb117cf32/service_keys",
							    "routes_url": "/v2/service_instances/519b0d69-19e4-4009-a363-461eb117cf32/routes"
							  }						
						}`),
					),
				)
	...
	Describe("FindByName", func() {
		Context("When there is match", func() {
							  ...
							  "resources": [
							    {
							      ...
							      "entity": {
							        ...
							        "space_guid": "259dffac-cf36-433f-9738-58a3b1af5668",
							        "gateway_data": null,
							        "dashboard_url": null,
							        "type": "managed_service_instance",
							        "last_operation": {
							        ...
							        "space_url": "/v2/spaces/259dffac-cf36-433f-9738-58a3b1af5668",
			...
			It("Should return the match", func() {
				...
				Expect(si.SpaceGUID).To(Equal("259dffac-cf36-433f-9738-58a3b1af5668"))
			})
		})
...
func newServiceInstances(url string) ServiceInstances {
	...
	return newServiceInstanceAPI(&cfClient)
}
